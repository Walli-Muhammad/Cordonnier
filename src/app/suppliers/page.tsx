    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 pt-32 pb-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl shadow-slate-900/5">
            <h3 className="text-slate-900 font-bold text-base mb-2">Digital Distribution</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
              List products on WALIM LTD storefronts and access our expanding online customer base.
            </p>
          </div>
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl shadow-slate-900/5">
            <h3 className="text-slate-900 font-bold text-base mb-2">Multi-Channel Growth</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
              Leverage multi-channel distribution integration including eBay and Amazon platform connectivity.
            </p>
          </div>
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl shadow-slate-900/5">
            <h3 className="text-slate-900 font-bold text-base mb-2">Controlled Approval</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
        ...
        <div id="application-form" className="bg-white border border-slate-200 rounded-3xl p-8 sm:p-12 shadow-2xl">
          
          <div className="border-b border-slate-100 pb-6 mb-8">
            <h2 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Supplier Application Form</h2>
            <p className="text-xs text-slate-500 mt-1">Please provide accurate company and product catalog information for review.</p>
          </div>
          ...
          {submittedId ? (
            <div className="py-12 text-center space-y-4">
              ...
              <h3 className="text-2xl font-bold text-slate-900 uppercase tracking-tight">Application Submitted</h3>
              <p className="text-sm text-slate-600 max-w-md mx-auto leading-relaxed">
                Thank you for applying to partner with WALIM LTD. Your application reference is <strong className="text-indigo-600 font-mono">{submittedId}</strong>. Our retail operations team will review your application.
              </p>
              <button
                onClick={() => setSubmittedId(null)}
                className="px-6 py-3 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold uppercase tracking-wider rounded-full transition-colors mt-4"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {errorMsg && (
                <div className="p-4 bg-red-50 border border-red-200 text-red-600 text-xs rounded-xl font-semibold">
                  ⚠️ {errorMsg}
                </div>
              )}
              ...
              <div className="space-y-4">
                <span className="text-xs uppercase font-extrabold tracking-widest text-indigo-600 block">01. Company Information</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-3 text-sm text-slate-900 focus:outline-none focus:border-indigo-600"
                    />
                  </div>
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                <span className="text-xs uppercase font-extrabold tracking-widest text-indigo-600 block">02. Product Categories &amp; Supply</span>
                
                <div>
                  <label className="text-xs font-bold text-slate-700 block mb-2">Select Supplied Categories *</label>
                ...
                <div>
                  <label className="text-xs font-bold text-slate-700 block mb-1">Product Range Description</label>
                  <textarea
                    rows={2}
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-4 py-3 text-sm text-slate-900 focus:outline-none focus:border-indigo-600 resize-none"
                  />
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="text-xs font-bold text-slate-700 block mb-1">Minimum Order Quantity (MOQ)</label>
                    <input
                      type="number"
                      min={1}
                      value={form.moq}
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                <span className="text-xs uppercase font-extrabold tracking-widest text-indigo-600 block">03. Business Registration &amp; Message</span>
                
                <div>
                  <label className="text-xs font-bold text-slate-700 block mb-1">Business Registration Info</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="text-xs font-bold text-slate-700 block mb-1">Additional Message / Cover Note</label>
                  <textarea
                    rows={3}
                    value={form.message}
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-bold uppercase text-xs tracking-[0.15em] rounded-full transition-all shadow-xl active:scale-98 disabled:opacity-50"
              >

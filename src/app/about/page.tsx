...
export const metadata: Metadata = { title: 'About Us | Cordonnier', description: 'The story behind Cordonnier — Pakistan\'s premium print-on-demand streetwear brand.' };
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-zinc-300 pt-28 pb-20 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl font-black text-white mb-6">About Cordonnier</h1>

        <div className="space-y-8 text-sm leading-7">
          <p className="text-zinc-300 text-base leading-8">
            <span className="text-white font-bold">Cordonnier</span> — Urdu for &ldquo;Identity&rdquo; — was founded in Lahore with one belief: your clothes should speak before you do.
          </p>

...
export const metadata: Metadata = { title: 'Contact Us | Cordonnier', description: 'Get in touch with the Cordonnier team.' };
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              {[
                ...
                { icon: '✉️', label: 'General', value: 'hello@cordonnier.co', href: 'mailto:hello@cordonnier.co' },
                { icon: '↩️', label: 'Returns', value: 'hello@cordonnier.co', href: 'mailto:hello@cordonnier.co' },
                { icon: '🔒', label: 'Privacy', value: 'hello@cordonnier.co', href: 'mailto:hello@cordonnier.co' },

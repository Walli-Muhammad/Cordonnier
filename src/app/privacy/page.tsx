...
export const metadata: Metadata = {
  title: 'Privacy Policy | Cordonnier',
  description: 'Learn how Cordonnier collects, uses, and protects your personal data.',
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert prose-zinc max-w-none space-y-10 text-sm leading-7">
          ...
          <section>
            ...
            <p>Cordonnier (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is a print-on-demand sneaker brand based in Lahore, Pakistan. Our registered address is Plot 12-B, DHA Phase 6, Lahore. You can reach our privacy team at <a href="mailto:hello@cordonnier.co" className="text-indigo-400 hover:underline">hello@cordonnier.co</a>.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-zinc-400">You may request access to, correction of, or deletion of your personal data at any time by emailing <a href="mailto:hello@cordonnier.co" className="text-indigo-400 hover:underline">hello@cordonnier.co</a>. We will respond within 30 days.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-zinc-400">For any privacy-related questions: <a href="mailto:hello@cordonnier.co" className="text-indigo-400 hover:underline">hello@cordonnier.co</a> | +92 329 188 1033</p>
          </section>

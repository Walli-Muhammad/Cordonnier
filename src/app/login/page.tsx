      ...
      <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-3xl p-8 shadow-2xl space-y-6">
        ...
        <div className="text-center">
          <span className="text-xs uppercase font-bold text-indigo-400 tracking-[0.2em] block mb-2">
            WALIM LTD Account Access
          </span>
          <h1 className="text-2xl font-black text-white uppercase tracking-tight">Customer Sign In</h1>
          <p className="text-xs text-zinc-500 mt-1">Sign in to manage orders, addresses, and wishlist items.</p>
        </div>

...
export const metadata: Metadata = { title: 'Returns & Exchanges | Cordonnier' };
        ...
        <div className="space-y-10 text-sm leading-7">
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2 text-zinc-400">
              <li>Email <a href="mailto:hello@cordonnier.co" className="text-indigo-400 hover:underline">hello@cordonnier.co</a> within 7 days of receiving your order.</li>

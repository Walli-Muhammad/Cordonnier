...
export const metadata: Metadata = {
  title: 'Shipping Information | Cordonnier',
  description: 'Shipping rates, delivery timeframes, and tracking information for Cordonnier orders.',
};
        ...
        <div className="space-y-10 text-sm leading-7">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-zinc-400">
              ...
              <li>Cordonnier is not responsible for delays caused by the courier or natural events beyond our control.</li>
              <li>Ensure your shipping address is accurate at checkout — we cannot reroute packages once dispatched.</li>
              <li>For international shipping inquiries, email <a href="mailto:hello@cordonnier.co" className="text-indigo-400 hover:underline">hello@cordonnier.co</a>.</li>
            </ul>
          </section>

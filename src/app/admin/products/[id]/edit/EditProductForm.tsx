...
export default function EditProductForm({ product }: EditProductFormProps) {
  const [form, setForm] = useState({
    ...
    stock_count: product.stock_count !== undefined ? String(product.stock_count) : '100',
    show_stock: product.show_stock !== undefined ? !!product.show_stock : true,
    colors: (product.colors || []) as { color_name: string; color_hex: string; image_url: string }[],
  });

...
export const metadata: Metadata = {
  title: 'Terms & Conditions | Cordonnier',
  description: 'The terms governing your use of the Cordonnier platform and purchases.',
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-sm leading-7">
          ...
          <section>
            ...
            <p className="text-zinc-400">By accessing or purchasing from Cordonnier (&quot;the Store&quot;), you agree to be bound by these Terms &amp; Conditions. If you do not agree, please do not use the Store.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-zinc-400">
              ...
              <li>Cordonnier reserves the right to refuse any design that is offensive, violates copyright, or breaches Pakistani law.</li>
          ...
          <section>
            ...
            <p className="text-zinc-400">All prices are listed in Pakistani Rupees (PKR). We accept JazzCash, EasyPaisa, and XPay. Prices include applicable taxes unless stated otherwise. Cordonnier reserves the right to update pricing without prior notice.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-zinc-400">By uploading designs to our studio, you confirm that you own the rights to the artwork or have permission to use it commercially. You grant Cordonnier a limited, non-exclusive license to print and fulfill your order. Cordonnier retains all rights to platform software, branding, and original designs.</p>
          </section>

          <section>
            <h2 className="text-white font-bold text-lg mb-3">6. Limitation of Liability</h2>
            <p className="text-zinc-400">Cordonnier&apos;s total liability for any claim arising from these terms shall not exceed the value of the disputed order. We are not liable for indirect, consequential, or incidental damages arising from use of the platform.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-zinc-400">Legal queries: <a href="mailto:hello@cordonnier.co" className="text-indigo-400 hover:underline">hello@cordonnier.co</a></p>
          </section>
